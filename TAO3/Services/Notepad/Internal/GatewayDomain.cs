...
namespace TAO3.Notepad.Internal
{
    ...
    internal class TextRange : IDisposable
    {
    ...
    /// </summary>
    internal enum IndicatorNumbers
    {
        CONTAINER = 8,
        IME = 32,
        IME_MAX = 35,
    ...
    internal enum FoldDisplayTextStyle
    {
        HIDDEN = 0,
        STANDARD = 1,
        BOXED = 2
    ...
    internal enum WrapVisualLocation
    {
        DEFAULT = 0x0000,
        END_BY_TEXT = 0x0001,
    ...
    /// </summary>
    internal enum ModificationFlags
    {
    }
    /// <summary>
    /// Notifications
    ...
    /// </summary>
    internal enum CompletionMethods
    {
        FILLUP = 1,
        DOUBLECLICK = 2,
        TAB = 3,
    ...
    internal enum LineCharacterIndexType
    {
        NONE = 0,
        UTF32 = 1,
        UTF16 = 2
